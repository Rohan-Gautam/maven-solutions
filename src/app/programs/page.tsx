...
export const metadata: Metadata = pageMetadata("Paper Chemical Programmes", "Explore Maven’s REDRAMAX and FIBRAMAX technical programmes for paper retention, drainage, formation and filler efficiency.", "/programs");
