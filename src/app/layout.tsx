...
export const metadata: Metadata = {
    ...
    icons: {icon: "/images/logo/1NB.svg"},
    openGraph: {
        title: "Maven Solutions | Pulp & Paper Chemicals India",
        description: "Specialty chemical solutions and technical programmes for pulp and paper manufacturing in India.",
        url: "/",
        siteName: "Maven Solutions",
        type: "website",
        images: [{url: ogImage, width: 1200, height: 630, alt: "Maven Solutions specialty chemical solutions"}]
    },
    twitter: {
